...
if model == 'topo2':
	if target in ['opti1', 'opti2', 'opti3', 'opti4', 'opti5', 'gof']:
		if target == 'gof':
			...
			if AB == '1':
				Tsc_12 = [ posterior['Tsc_12'] for i in range(nMultilocus) ]
				Tsc_12 = [ Tsc_12[i] if Tsc_12[i]<Tsplit_24[i] else Tsplit_24[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_12 = [0] * nMultilocus
			if AC == '1':
	#			Tsc_13 = [ uniform(low = T_bound[0], high = time_space*Tsplit_23[i], size = None) for i in range(nMultilocus) ]
				Tsc_13 = [ posterior['Tsc_13'] for i in range(nMultilocus) ]
				Tsc_13 = [ Tsc_13[i] if Tsc_13[i]<Tsplit_34[i] else Tsplit_34[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_13 = [0] * nMultilocus
			if AD == '1':
	#			Tsc_14 = [ uniform(low = T_bound[0], high = time_space*Tsplit_24[i], size = None) for i in range(nMultilocus) ]
				Tsc_14 = [ posterior['Tsc_14'] for i in range(nMultilocus) ]
				Tsc_14 = [ Tsc_14[i] if Tsc_14[i]<Tsplit_34[i] else Tsplit_34[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_14 = [0] * nMultilocus
			if BC == '1':
	#			Tsc_23 = [ uniform(low = T_bound[0], high = time_space*Tsplit_23[i], size = None) for i in range(nMultilocus) ]
				Tsc_23 = [ posterior['Tsc_23'] for i in range(nMultilocus) ]
				Tsc_23 = [ Tsc_23[i] if Tsc_23[i]<Tsplit_34[i] else Tsplit_34[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_23 = [0] * nMultilocus
			if BD == '1':
	#			Tsc_24 = [ uniform(low = T_bound[0], high = time_space*Tsplit_23[i], size = None) for i in range(nMultilocus) ] # maintenant limite par Tsplit_34 et non plus Tsplit_24
				Tsc_24 = [ posterior['Tsc_24'] for i in range(nMultilocus) ]
				Tsc_24 = [ Tsc_24[i] if Tsc_24[i]<Tsplit_34[i] else Tsplit_34[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_24 = [0] * nMultilocus
			if CD == '1':
				Tsc_34 = [ posterior['Tsc_34'] for i in range(nMultilocus) ]
				Tsc_34 = [ Tsc_34[i] if Tsc_34[i]<Tsplit_34[i] else Tsplit_34[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_34 = [0] * nMultilocus
...
if model == 'topo3':
	if target in ['opti1', 'opti2', 'opti3', 'opti4', 'opti5', 'gof']:
		if target == 'gof':
			...
			if AB == '1':
				Tsc_12 = [ posterior['Tsc_12'] for i in range(nMultilocus) ]
				Tsc_12 = [ Tsc_12[i] if Tsc_12[i]<Tsplit_12[i] else Tsplit_12[i]-epsilon for i in range(nMultilocus) ] #2026-06 CFraisseRios
			else:
				Tsc_12 = [0] * nMultilocus
			if AC == '1':
	#			Tsc_13 = [ uniform(low = T_bound[0], high = time_space*Tsplit_23[i], size = None) for i in range(nMultilocus) ]
